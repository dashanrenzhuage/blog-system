...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">Home Page</a> &raquo; Edit Article Category
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <form action="{{url('admin/category/'.$field->cate_id)}}" method="post">
            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        <th width="170"><i class="require">*</i>Parent Category：</th>
                        <td>
                    ...
                    <tr>
                        <th><i class="require">*</i>Category Order：</th>
                        <td>
